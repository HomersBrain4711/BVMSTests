...
function TC56369_TestSequence_ForwardBackward()
{
  ...
  Helpers.ClickTrickPlayBarButton(ButtonAction.PlayBackward);
  ...
  Helpers.ClickTrickPlayBarButton(ButtonAction.PlayForward);
...
function TC56371_TestSequence_StepForward()
{
  ...
  for(var i = 0; i < 6; i++)
  {
    ...
    //click StepForward
    //sequenceNavigationBar.Click(157, 12);
    Helpers.ClickTrickPlayBarButton(ButtonAction.StepForward);
...
function TC56370_TestSequence_StepBackward()
{
  ...
  for(var i = 0; i < 6; i++)
  {
    ...
    Helpers.ClickTrickPlayBarButton(ButtonAction.StepBackward);
